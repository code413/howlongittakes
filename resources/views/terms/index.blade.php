...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <p>Unless otherwise stated, Code413 and/or it’s licensors own the intellectual property rights for
                ...
                pages from https://www.howlongittakes.com for your own personal use subject to restrictions set in these
    ...
    <div class="row">
        <div class="col">
            ...
            <p>We will approve link requests from these organizations if we determine that: (a) the link would not
                ...
                the visibility associated with the hyperlink outweighs the absence of Code413; and (d) where the
            ...
            <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
                website,
                you must notify us by sending an e-mail to <a href="mailto:farzad@code413.io"
                                                              title="send an email to farzad@code413.io">farzad@code413.io</a>.
    ...
    <p>This Terms and conditions page was created at <a style="color:inherit;text-decoration:none;cursor:text;"
                                                        href="https://termsandconditionstemplate.com">termsandconditionstemplate.com</a>
