...
@section('content')
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col">
                <p>These terms and conditions outline the rules and regulations for the use of Code413's Website.</p>
        ...
        <div class="row">
            <div class="col">
                <h2>Cookies</h2>
                <p>We employ the use of cookies. By using Code413's website you consent to the use of cookies
                    in accordance with Code413’s privacy policy.</p>
        ...
        <div class="row">
            <div class="col">
                <h2>License</h2>
                <p>Unless otherwise stated, Code413 and/or it’s licensors own the intellectual property rights for
                    all material on Code413. All intellectual property rights are reserved. You may view and/or print
                    pages from https://www.howlongittakes.com for your own personal use subject to restrictions set in
                    these
                    terms and conditions.</p>
                <p>You must not:</p>
                <ol>
                    <li>Republish material from https://www.howlongittakes.com</li>
                    <li>Sell, rent or sub-license material from https://www.howlongittakes.com</li>
                    <li>Reproduce, duplicate or copy material from https://www.howlongittakes.com</li>
                </ol>
                <p>Redistribute content from Code413 (unless content is specifically made for redistribution).</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <ol start="2">
                    <li>These organizations may link to our home page, to publications or to other Web site information
                        ...
                        <ol type="a">
                            ...
                            <li>does not falsely imply sponsorship, endorsement or approval of the linking party and its
                ...
                <ol type="a">
                    <li>the link would not reflect unfavorably on us or our accredited businesses (for example, trade
                    ...
                    <li>the benefit to us from
                        the visibility associated with the hyperlink outweighs the absence of Code413; and
                    </li>
                    <li>where the
                ...
                <ol type="a">
                    <li>is not in any way misleading;</li>
                    <li>does not falsely imply sponsorship, endorsement or approval
                        of the linking party and it products or services; and
                    </li>
                    <li>fits within the context of the linking party's</li>
                    site.
                </ol>

                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
                    website,
                    you must notify us by sending an e-mail to <a href="mailto:hello@code413.io"
                                                                  title="send an email to hello@code413.io">hello@code413.io</a>.
                ...
                <p>No use of Code413’s logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <p>To the maximum extent permitted by applicable law, we exclude all representations, warranties and
                    ...
                    implied by
                    law in respect of satisfactory quality, fitness for purpose and/or the use of reasonable care and
                    skill).
